import React from 'react';
  ...
  export default function MyComponent() {
    return (<div className="flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
  ...
  export function MyOtherComponent() {
    return <div>What I have two components!?</div>
  }
  
  export function MyThirdComponent() {
    return (
      <img
      src="https://i.imgur.com/00a33O6.jpeg"
      alt="elon musk"
      width="600"
    />
    )
